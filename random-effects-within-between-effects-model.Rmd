...
If the Gauss-Markov-assumption is correlated, it's recommended to fit a complex random-effect-within-between model (REWB). This requires de- and group-meaning the time-varying predictors. Depending on the data structure, random slope and intercept may correlate or not.
